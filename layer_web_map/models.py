...
class LayerWebMap(models.Model):
    ...
    get_map_url = models.CharField(max_length=500,null=True,blank=True)
    get_map_names = models.CharField(max_length=255,null=True,blank=True)
    enable_chart_timeseries = models.BooleanField()
    timeseries_url = models.CharField(max_length=500,null=True,blank=True)
    ...
    table_url = models.CharField(max_length=500,null=True,blank=True)
